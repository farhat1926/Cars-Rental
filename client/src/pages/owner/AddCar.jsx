...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      <Title title= "Add New Car" subTitle="Fill in details to List a new car for bookings, including pricing, availabiility and car specification" />
  ...
  <div className='flex flex-col w-full'>
    ...
    />
      ...
      {/* car transmission, fuel type  */}
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
         <div className='flex flex-col w-full'>
          <label>Trasmission</label>
