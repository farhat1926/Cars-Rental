    ...
    <div>
      ...
      <div className='flex flex-col items-center py-20 bg-light max-md:px-4'>
        ...
        <div className='flex items-center bg-white px-4 mt-6 max-w-140 w-full h-12 rounded-full shadow'>
          ...
          <input onChange={(e)=> setInput(e.target.value)}  value={input} type='text' placeholder ='search by make, model or features' className='w-full h-full outline-noone text-gray-500' />
          <img src={assets.filter_icon} alt="" className='w-4.5 h-4.5 mr-2'/>
          
        </div>
      </div>
      <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-10'>
        <p className='text-gray-500 xl:px-20 max-w-7xl mt-auto'>Showing {filteredCars.length} Cars</p>
